...
(function(e, t, r) {
    ...
    function n(r) {
        ...
        yt = r.edgeStrategy || "set", ct = {
            ...
            render: r.render
        }, ft = r.forceHeight !== !1, ft && (zt = r.scale || 1), pt = r.mobileDeceleration || E, gt = r.smoothScrolling !== !1, vt = r.smoothScrollingDuration || x, dt = {
        ...
        Z = function() {
            ...
            if (mt) o >= mt.endTime ? (n = mt.targetTop, e = mt.done, mt = r) : (t = mt.easing((o - mt.startTime) / mt.duration), n = 0 | mt.startTop + t * mt.topDiff), it.setScrollTop(n, !0);
                ...
                a && (dt = {
                    ...
                    startTime: It,
                    endTime: It + vt
                }), dt.endTime >= o && (t = U.sqrt((o - dt.startTime) / vt), n = 0 | dt.startTop + t * dt.topDiff)
            }
    ...
    var r = {
        ...
        goTo: function(e, n, r) {
            ...
            if (i.options.transitionStyle !== false && r !== "drag" && i.options.items === 1 && i.browser.support3d === true) {
                ...
                if (i.browser.support3d === true) {
                    ...
                    i.css2fade(i.positionsInArray[e], 1)
                }
                i.afterGo();
            ...
            if (i.browser.support3d === true) {
                ...
                if (n === true) {
                    i.css2fade(s, i.options.paginationSpeed)
                } else if (n === "rewind") {
                    i.css2fade(s, i.options.rewindSpeed)
                } else {
                    i.css2fade(s, i.options.slideSpeed)
                }
            }
            i.afterGo()
        },
        jumpTo: function(e) {
            ...
            if (t.browser.support3d === true) {
                ...
                t.css2fade(t.positionsInArray[e], 1)
            }
